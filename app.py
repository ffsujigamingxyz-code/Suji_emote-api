...
async def MaiiiinE():
    ...
    # BOT LOGIN UID
    BOT_UID = int('14278815370')  # <-- FIXED BOT UID

    Uid, Pw = '4374234136', '4C3EA5A69555F48428F599097E8B13F9D10CB9D9EFAC6C898EF5F04A42E2A0F5'
